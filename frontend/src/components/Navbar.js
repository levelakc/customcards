...
export default function Navbar() {
    ...
    return (
        <nav className="bg-black bg-opacity-50 backdrop-blur-lg sticky top-0 z-50 text-white shadow-lg">
                        ...
                        <div className="flex-shrink-0 h-10">
                            {finalLogoUrl && (
                                <button onClick={() => navigate('home')} className="cursor-pointer focus:outline-none">
                                    <img src={finalLogoUrl} alt="VIPCard Logo" className="h-10" height="56px" width="56px" />
                                </button>
                            )}
                        </div>
