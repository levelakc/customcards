...
import { getDashboardStats, getDashboardSummary, getSalesTrend, getTopSellingProducts, getSalesByCategory, sendBroadcastEmail } from '../controllers/adminController.js';
...
// @access  Private/Admin
router.route('/broadcast').post(protect, admin, sendBroadcastEmail);
